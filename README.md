...
| 要素 | 内容 |
|------|------|
| **Logo** | 立体像素风（Voxel Art）猫耳 M + 无麦克风包裹式耳麦 → `public/icon-1024.png` |
| **Slogan** | **STILL HERE.** |
| **主色** | 日光橙（Sunlight Orange） |
| **背景** | 极客碳黑（Carbon Black） |
| **定位** | 克制不打扰、长期陪伴、适配 Steam Deck 深夜游戏场景 |
...
它是 **AI DJ + 情绪电台 + 游戏陪伴**——有情绪感、有陪伴感、有时间感。
...
- 🎙️ **DJ 开场白** — 像电台一样有温度，参考你的 Music DNA
