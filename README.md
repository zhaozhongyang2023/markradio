...
MoodWave 应该像 **Spotify AI DJ + 情境电台 + 游戏陪伴**。

AI 不是工具，是**会陪伴你的电台 DJ**——有情绪感、有陪伴感、有时间感、有情境电台 氛围。
...
支持**极简播放视图**：游戏中点「◁ 极简」进入紧凑模式，显示加载进度、当前歌曲、同步歌词、天气、心情和场景文案（电台/寻歌/游戏各有专属格式），关闭后自动记忆。
